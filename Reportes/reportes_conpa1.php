...
<nav>
 ...
 <center> <h1> Informes con parametros 1</h1><center>
 </header>  
  <br>
  <br>
   ...
   <br>  
  <div class="form">
   <form method ='GET'action="reportes_conpa2.php">
   <br>
   <br>
   <br>
   <center>
    <td >Nombre:</td><br>
    <br>
    <input type="text" plachedolder ="Introduzca Nombre" name ="txtusuario"required>
    <br>
    <br>
