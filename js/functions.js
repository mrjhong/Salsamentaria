            ...
            success: function (response) {
                if (response != 'error') {
                    ...
                    $('.bodyModal').html('<form action="" method="post" name="form_add_product" id="form_add_product" onsubmit="event.preventDefault();sendDataProduct();">' +
                        ...
                        '<button type="submit" class="btn_new"><i class="fas faplus"></i> Agregar</button>' +
                        '<a href="#" class="btn_cancel closeModal"onclick="coloseModal();"><i class="fas fa-ban"></i> Cerrar</a>' +
                        '</form>');
                }
            },
            ...
            success: function (response) {
                if (response != 'error') {
                    ...
                    $('.bodyModal').html('<form action="" method="post"name="form_del_product" id="form_del_product" onsubmit="event.preventDefault();delProduct();">' +
                        ...
                        '<button type="submit" class="btn_ok"><i class="far fa-trashalt"></i> Eliminar</button>' +
                        '</form>');
                }
            },
            error: function (error) {
            ...
            success: function (response) {
                if (response != 'error') {
                    ...
                    $('.bodyModal').html('<form action="" method="post" name="form_anular_factura" id="form_anular_factura" onsubmit="event.preventDefault(); anularFactura();">' +
                        ...
                        '<div class="alert alertAddProduct"></div>' +
                        '<button type="submit" class="btn_ok"><i class="far fa-trashalt"></i> Anular</button>' +
                        '<a href="#" class="btn_cancel" onclick="coloseModal();"><i class="fas fa-ban"></i> Cerrar</a>' +
                        '</form>');
                }
            },
